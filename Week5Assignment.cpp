...
*  Date: 02-16-2022
*  
* Modify Assignment 3 to include a Deque, and/or a List.
* Limit the number of attempts to guess the word.
* Provide additional feedback to the user, guessed incorrect letters,
* You win/you lose messages, etc.
* Give the user a "hint" upon request.
*/
